...
## Generate translation for all supported languages
- You must create .resx entries for all supported languages. Other rules in this document may specify exceptions.
...
Do not add a key to culture file, if the translation is identical to the neutral file. The neutral file is the fallback for every culture, so it is.
