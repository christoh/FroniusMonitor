...
public partial class MainWindow
{
    ...
    public MainWindow()
    {
        ...
        Loaded += async (_, _) =>
        {
            ...
            await Dispatcher.InvokeAsync(()=>ViewModel.SolarSystemService.NewDataReceived += OnPowerFlowChanged);
        };
    }
    ...
    private async void OnPowerFlowChanged(object? sender, SolarDataEventArgs e)
    {
