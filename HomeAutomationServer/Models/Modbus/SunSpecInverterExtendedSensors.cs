namespace De.Hochstaetter.HomeAutomationServer.Models.Modbus;

public class SunSpecInverterExtendedSensors(ReadOnlyMemory<byte> data, ushort modelNumber, ushort absoluteRegister) : SunSpecModelBase(data, modelNumber, absoluteRegister)
{
